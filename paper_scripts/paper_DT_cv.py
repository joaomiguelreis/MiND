...
for i in range(ncells):
	...
	precision_3 = cross_val_score(DecisionTreeClassifier(max_depth=3), X, y, scoring = 'precision', cv=10)
	precision_6 = cross_val_score(DecisionTreeClassifier(max_depth=6), X, y, scoring = 'precision', cv=10)
	precision_9 = cross_val_score(DecisionTreeClassifier(max_depth=9), X, y, scoring = 'precision', cv=10)

	# Making predictions on the testing features set with recall metric
	recall_3 = cross_val_score(DecisionTreeClassifier(max_depth=3), X, y, scoring='recall', cv=10)
	recall_6 = cross_val_score(DecisionTreeClassifier(max_depth=6), X, y, scoring='recall', cv=10)
	recall_9 = cross_val_score(DecisionTreeClassifier(max_depth=9), X, y, scoring='recall', cv=10)
...
for i in range(ncells):
	...
	# Making predictions on the testing features set with precision metric
	precision_3 = cross_val_score(DecisionTreeRegressor(max_depth=3), X, y, scoring = 'neg_mean_squared_error', cv=10)
	precision_6 = cross_val_score(DecisionTreeRegressor(max_depth=6), X, y, scoring = 'neg_mean_squared_error', cv=10)
	precision_9 = cross_val_score(DecisionTreeRegressor(max_depth=9), X, y, scoring = 'neg_mean_squared_error', cv=10)
...
# if prediction_3.mean() == 0 and prediction_6.mean() == 0 and prediction_9.mean() == 0:
#	accuracy_3.append(1.)
#	accuracy_6.append(1.)
#	accuracy_9.append(1.)
# else:
# accuracy_3.append(prediction_3.mean())
# accuracy_6.append(prediction_6.mean())
# accuracy_9.append(prediction_9.mean())

# if recall_3.mean() == 0 and recall_6.mean() == 0 and recall_9.mean() == 0:
#	rec_3.append(1.)
#	rec_6.append(1.)
#	rec_9.append(1.)
# else:
# rec_3.append(recall_3.mean())
# rec_6.append(recall_6.mean())
# rec_9.append(recall_9.mean())
