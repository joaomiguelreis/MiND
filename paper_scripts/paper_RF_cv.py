...
for i in range(ncells):
	...
	precision_3 = cross_val_score(RandomForestClassifier(max_depth=3), X, y, scoring = 'precision', cv=10)
	precision_6 = cross_val_score(RandomForestClassifier(max_depth=6), X, y, scoring = 'precision', cv=10)
	precision_9 = cross_val_score(RandomForestClassifier(max_depth=9), X, y, scoring = 'precision', cv=10)

	# Making predictions on the testing features set with recall metric
	recall_3 = cross_val_score(RandomForestClassifier(max_depth=3), X, y, scoring='recall', cv=10)
	recall_6 = cross_val_score(RandomForestClassifier(max_depth=6), X, y, scoring='recall', cv=10)
	recall_9 = cross_val_score(RandomForestClassifier(max_depth=9), X, y, scoring='recall', cv=10)
...
for i in range(ncells):
	...
	# Making predictions on the testing features set with precision metric
	precision_3 = cross_val_score(RandomForestRegressor(max_depth=3), X, y, scoring = 'neg_mean_squared_error', cv=10)
	precision_6 = cross_val_score(RandomForestRegressor(max_depth=6), X, y, scoring = 'neg_mean_squared_error', cv=10)
	precision_9 = cross_val_score(RandomForestRegressor(max_depth=9), X, y, scoring = 'neg_mean_squared_error', cv=10)
